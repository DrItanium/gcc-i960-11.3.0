...
(define_insn "branch_if_bit_set_operation_v0"
  [(set (pc)
	(if_then_else
...
(define_insn "branch_if_bit_clear_operation_v0"
  [(set (pc)
	(if_then_else
...
(define_insn "branch_if_bit_set_operation_v1"
  [(set (pc)
	(if_then_else
...
(define_insn "branch_if_bit_clear_operation_v1"
  [(set (pc)
	(if_then_else
...
(define_insn "compare_and_increment_integer_operation"
  [(set (reg:CC 36)
...
(define_insn "compare_and_increment_ordinal_operation"
  [(set (reg:CC_UNS 36)
	(compare (match_operand:SI 0 "arith_operand" "d")
		 (match_operand:SI 1 "arith_operand" "+d")))
   (set (match_dup 1) (plus:SI (match_dup 1) (const_int 1)))]
...
{
  if (GET_CODE (operands[2]) == CONST_INT && INTVAL (operands[2]) < 0)
    return \"andnot	%C2,%1,%0 # andsi3, v0\";
  if (i960_bypass (insn, operands[1], operands[2], 0))
    return \"and	%2,%1,%0 # andsi3, v1\";
  return \"and	%1,%2,%0 # andsi3, v2\";
}")
...
{
  if (GET_CODE (operands[2]) == CONST_INT && INTVAL (operands[2]) < 0)
    return \"ornot	%C2,%1,%0 # iorsi3, v0\";
  if (i960_bypass (insn, operands[1], operands[2], 0))
    return \"or	%2,%1,%0 # iorsi3, v1\";
  return \"or	%1,%2,%0 # iorsi3, v2\";
}")
...
{
  if (i960_bypass (insn, operands[1], operands[2], 0))
    return \"xnor	%2,%1,%0 # xnor_op0_bypass\";
  return \"xnor	%1,%2,%0 # xnor_op0_no_bypass\";
}")
...
{
  if (i960_bypass (insn, operands[1], operands[2], 0))
    return \"nor	%2,%1,%0 # nor_op0_bypass\";
  return \"nor	%1,%2,%0 # nor_op0_no_bypass\";
}")
...
{
  if (i960_bypass (insn, operands[1], operands[2], 0))
    return \"nand	%2,%1,%0 # nand_op0_bypass\";
  return \"nand	%1,%2,%0 # nand_op0_no_bypass\";
}")
