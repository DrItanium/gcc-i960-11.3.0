...
(define_expand "cbranchsf4"
    [(set (pc)
       (if_then_else (match_operator 0 "comparison_operator"
                        [(match_operand:SF 1 "fp_arith_operand" "")
  ...
  [(set (pc)
	(if_then_else
	 (match_operator 0 "comparison_operator"
			 [(match_operand:SF 1 "arith_operand" "d")
			  (match_operand:SF 2 "arith_operand" "dI")])
	 (label_ref (match_operand 3 "" ""))
	 (pc)))]
  "TARGET_NUMERICS"
  ;; "cmp%S0%B0%R0%+	%2,%1,%l3"
...
;; ledf2 and other functions are composed of the compare itself plus the less
;; than or equal to part
