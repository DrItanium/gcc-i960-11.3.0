...
(define_insn ""
  [(set (match_operand:SI 0 "nonimmediate_operand" "=d")
	(eq:SI (match_operand:SI 1 "register_operand" "d") (reg:SI 37)))]
  ""
  "shro	%1,1,%0"
  [(set_attr "type" "alu2")])
...
(define_insn ""
  [(set (match_operand:SI 0 "nonimmediate_operand" "=d")
	(match_operator:SI 1 "comparison_operator" [(reg:CC 36) (reg:SI 37)]))]
  ""
  "test%C1	%0"
  [(set_attr "type" "compare")])
...
(define_insn ""
  [(set (match_operand:SI 0 "nonimmediate_operand" "=d")
	(match_operator:SI 1 "comparison_operator" [(reg:CC_UNS 36) (reg:SI 37)]))]
  ""
  "test%C1	%0"
  [(set_attr "type" "compare")])
...
(define_expand "cstoresi4"
 [(set (match_operand:SI 0 "general_operand" "=d")
  ...
  ""
  {
    ...
    operands[3] = gen_rtx_REG(SImode, 37);
...
""
{
    ...
    operands[2] = gen_rtx_REG(SImode, 37);
...
(define_insn "*if_cond_then_jump_else_fallthrough"
  [(set (pc)
	(if_then_else (match_operator 0 "comparison_operator"
				      [(reg:CC 36) (reg:SI 37)])
...
(define_insn "*if_cond_then_fallthrough_else_jump"
  [(set (pc)
	(if_then_else (match_operator 0 "comparison_operator"
				      [(reg:CC 36) (reg:SI 37)])
		      (pc)
