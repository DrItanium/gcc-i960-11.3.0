...
(define_insn "*movdf2_internal_reg_to_reg_hardfloat"
 [(set (match_operand:DF 0 "register_operand" "=f,d,f,d")
     (match_operand:DF 1 "register_operand" "f,d,d,f"))]
 "TARGET_NUMERICS"
 "@
   movrl\t%1,%0
   movl\t%1,%0
...
(define_insn "*movdf2_internal_g14_available"
  [(set (match_operand:DF 0 "nonimmediate_operand" "=d,d,d,m,o")
	(match_operand:DF 1 "fpmove_src_operand" "d,F,m,d,G"))]
  "i960_can_use_g14_for_zero_store()"
  "*
{
  switch (which_alternative)
  ...
  "*
{
  ...
  [(set_attr "type" "move,load,fpload,fpstore")])
...
(define_insn "*movsf2_internal_reg_to_reg_hardfloat"
...
(define_insn "*movsf2_internal_g14_available"
  [(set (match_operand:SF 0 "nonimmediate_operand" "=d,d,d,m")
	(match_operand:SF 1 "fpmove_src_operand" "d,F,m,dG"))]
  "i960_can_use_g14_for_zero_store()"
  "*
{
  switch (which_alternative)
...
(define_insn "*movsf2_internal_g14_unavailable"
  [(set (match_operand:SF 0 "nonimmediate_operand" "=d,d,d,m")
	(match_operand:SF 1 "fpmove_src_operand" "d,F,m,d"))]
  "i960_cannot_use_g14_for_zero_store()"
  "*
{
  switch (which_alternative)
...
(define_insn "*movtf2_load_store"
  [(set (match_operand:TF 0 "nonimmediate_operand"  "=d,d,d,m")
	    (match_operand:TF 1 "fpmove_src_operand"    "d,F,m,d"))]
