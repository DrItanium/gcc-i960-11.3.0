...
;; cmpi, cmpo, cmpr, cmprl, bbc, bbs instructions need to be handled
...
;; some day.
;; cmpinci, cmpinco, cmpdeci, cmpdeco need to be handled
;; test instructions need to be handled as well
(define_insn ""
  [(set (match_operand:SI 0 "nonimmediate_operand" "=d")
	(eq:SI (match_operand:SI 1 "register_operand" "d") (const_int 0)))]
  ""
  "shro	%1,1,%0 # equals zero form 0"
  [(set_attr "type" "alu2")])
  ...
  "*
{
  switch (which_alternative)
    {
    case 0:
      return \"mov	%1,%0 # case 0 mov_match 0\";
    case 1:
      return i960_output_ldconst (operands[0], operands[1]);
    case 2:
      return \"ld	%1,%0 # case 2 mov_match 0\";
    case 3:
      if (operands[1] == const0_rtx)
	return \"st	g14,%0 # case 3, mov_match 0 cond true\";
      return \"st	%1,%0 # case 3, mov_match 0 cond false\";
    default:
      abort();
    }
}"
  ...
  "*
{
  switch (which_alternative)
    {
    case 0:
      return \"mov	%1,%0 # case 0 mov_match 1\";
    case 1:
      return i960_output_ldconst (operands[0], operands[1]);
    case 2:
      return \"ld	%1,%0 # case 2 mov_match 1\";
    case 3:
      return \"st	%1,%0 # case 3 mov_match 1\";
    default:
      abort();
    }
}"
