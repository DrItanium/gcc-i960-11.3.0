...
(define_insn "*movdf2_internal_fpr_to_fpr"
 [(set (match_operand:DF 0 "fpr_operand" "=f")
     (match_operand:DF 1 "fpr_operand" "f"))]
 "TARGET_NUMERICS"
 "movrl\t%1,%0"
 [(set_attr "type" "fpmove")])

(define_insn "*movdf2_internal_gpr_to_gpr"
 [(set (match_operand:DF 0 "gpr_operand" "=d")
     (match_operand:DF 1 "gpr_operand" "d"))]
 "TARGET_NUMERICS"
 "movl\t%1,%0"
 [(set_attr "type" "move")])

(define_insn "*movdf2_internal_gpr_to_fpr"
 [(set (match_operand:DF 0 "fpr_operand" "=f")
     (match_operand:DF 1 "gpr_operand" "d"))]
 "TARGET_NUMERICS"
 "movrl\t%1,%0"
...
(define_insn "*movdf2_internal_fpr_to_gpr"
 [(set (match_operand:DF 0 "gpr_operand" "=d")
     (match_operand:DF 1 "fpr_operand" "f"))]
 "TARGET_NUMERICS"
 "movrl\t%1,%0"
...
(define_insn "*movsf2_internal_fpr_to_fpr"
 [(set (match_operand:SF 0 "fpr_operand" "=f")
     (match_operand:SF 1 "fpr_operand" "f"))]
 "TARGET_NUMERICS"
 "movr\t%1,%0"
 [(set_attr "type" "move")])

(define_insn "*movsf2_internal_gpr_to_gpr"
 [(set (match_operand:SF 0 "gpr_operand" "=d")
     (match_operand:SF 1 "gpr_operand" "d"))]
 "TARGET_NUMERICS"
 "mov\t%1,%0"
 [(set_attr "type" "move")])
(define_insn "*movsf2_internal_gpr_to_fpr"
 [(set (match_operand:SF 0 "fpr_operand" "=f")
     (match_operand:SF 1 "gpr_operand" "d"))]
 "TARGET_NUMERICS"
 "movr\t%1,%0"
...
(define_insn "*movsf2_internal_fpr_to_gpr"
 [(set (match_operand:SF 0 "gpr_operand" "=d")
     (match_operand:SF 1 "fpr_operand" "f"))]
 "TARGET_NUMERICS"
 "movr\t%1,%0"
