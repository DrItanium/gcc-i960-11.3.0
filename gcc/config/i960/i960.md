...
[(set (match_operand:TF 0 "nonimmediate_operand" "=r")
      (match_operand:TF 1 "fpmove_src_operand" "r"))]
...
;;(define_insn "fpmove_transfer0"
;;  [(set (match_operand:TF 0 "nonimmediate_operand"  "=r,f,d,d,m,f")
;;	    (match_operand:TF 1 "fpmove_src_operand"    "r,GH,F,m,d,r"))]
;;  "register_operand (operands[0], TFmode) || register_operand (operands[1], TFmode)"
;;  "* {
;;  switch (which_alternative)
;;    {
...
;;    }
;;}"
;;  [(set_attr "type" "move,move,load,fpload,fpstore,move")])
