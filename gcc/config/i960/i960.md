...
(define_insn "branch_if_bit_clear"
  [(set (pc)
	(if_then_else
...
(define_insn "branch_if_bit_set2"
  [(set (pc)
	(if_then_else
...
(define_insn "branch_if_bit_clear2"
  [(set (pc)
	(if_then_else
...
(define_insn "compare_increment_integer"
  [(set (reg:CC 36)
...
(define_insn "compare_increment_ordinal"
  [(set (reg:CC_UNS 36)
	(compare (match_operand:SI 0 "arith_operand" "d")
		 (match_operand:SI 1 "arith_operand" "+d")))
   (set (match_dup 1) (plus:SI (match_dup 1) (const_int 1)))]
...
(define_insn "compare_decrement_integer"
  [(set (reg:CC 36)
	(compare (match_operand:SI 0 "arith_operand" "d")
		 (match_operand:SI 1 "arith_operand" "+d")))
...
(define_insn "compare_decrement_ordinal"
  [(set (reg:CC_UNS 36)
	(compare (match_operand:SI 0 "arith_operand" "d")
		 (match_operand:SI 1 "arith_operand" "+d")))
   (set (match_dup 1) (minus:SI (match_dup 1) (const_int 1)))]
...
(define_expand "sgt"
  ...
  "
{
  operands[1] = i960_gen_compare_reg (GT, i960_compare_op0, i960_compare_op1);
}")
...
(define_expand "sgtu"
  ...
  "
{
  operands[1] = i960_gen_compare_reg (GTU, i960_compare_op0, i960_compare_op1);
}")
...
(define_expand "slt"
  ...
  "
{
  operands[1] = i960_gen_compare_reg (LT, i960_compare_op0, i960_compare_op1);
}")
...
(define_expand "sltu"
  ...
  "
{
  operands[1] = i960_gen_compare_reg (LTU, i960_compare_op0, i960_compare_op1);
}")
...
(define_expand "sge"
  ...
  "
{
  operands[1] = i960_gen_compare_reg (GE, i960_compare_op0, i960_compare_op1);
}")
...
(define_expand "sgeu"
  ...
  "
{
  operands[1] = i960_gen_compare_reg (GEU, i960_compare_op0, i960_compare_op1);
}")
...
(define_expand "sle"
  ...
  "
{
  operands[1] = i960_gen_compare_reg (LE, i960_compare_op0, i960_compare_op1);
}")
...
(define_expand "sleu"
  ...
  "
{
  operands[1] = i960_gen_compare_reg (LEU, i960_compare_op0, i960_compare_op1);
}")
...
(define_insn "store_zero_to_memory"
...
;; The store case can not be separate.  See above.
(define_insn "store_zero_to_memory2"
  [(set (match_operand:HI 0 "nonimmediate_operand" "=d,d,d,m")
...
;; The store case can not be separate.  See comment above.
(define_insn "store_zero_to_memory3"
  [(set (match_operand:QI 0 "nonimmediate_operand" "=d,d,d,m")
...
;; The store case can not be separate.  See comment above.
(define_insn "store_zero_to_memory4"
...
;; The store case can not be separate.  See comment above.
(define_insn "store_zero_to_memory5"
...
(define_insn "load_short_integer"
...
(define_insn "load_byte_integer2"
...
(define_insn "load_short_ordinal"
  [(set (match_operand:SI 0 "register_operand" "=d")
...
(define_insn "load_byte_ordinal2"
  [(set (match_operand:HI 0 "register_operand" "=d")
...
;; symbolic constants.
;; deactivate this one since it is dependent on C_SERIES which I'm not
...
(define_insn "nand_or_notor_or_ornot_select"
  [(set (match_operand:SI 0 "register_operand" "=d")
	(ior:SI (not:SI (match_operand:SI 1 "register_operand" "d"))
		(match_operand:SI 2 "logic_operand" "dIM")))]
  ""
