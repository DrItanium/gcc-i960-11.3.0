...
(define_insn "*movdf_fp_literal"
 [(set (match_operand:DF 0 "register_operand" "=df")
     (match_operand:DF 1 "fp_literal" "GH"))]
 "TARGET_NUMERICS"
 "movrl\t%1,%0"
 [(set_attr "type" "fpmove")])

(define_insn "*movdf2_internal_same_to_same"
 [(set (match_operand:DF 0 "register_operand" "=f,d,f,d")
     (match_operand:DF 1 "fpmove_src_operand" "f,d,d,f"))]
 "TARGET_NUMERICS"
 "@
   movrl\t%1,%0
   movl\t%1,%0
   movrl\t%1,%0
   movrl\t%1,%0"
 [(set_attr "type" "fpmove,move,fpmove,fpmove")])

(define_insn "*movdf2_internal_g14_available"
  [(set (match_operand:DF 0 "nonimmediate_operand" "=d,d,m,o")
	(match_operand:DF 1 "fpmove_src_operand" "F,m,d,G"))]
  "TARGET_NUMERICS && i960_can_use_g14_for_zero_store()"
  "*
{
  switch (which_alternative)
    {
  ...
  [(set_attr "type" "load,fpload,fpstore,fpstore")])


(define_insn "*movdf2_internal_g14_unavailable"
  [(set (match_operand:DF 0 "nonimmediate_operand" "=d,d,m")
	(match_operand:DF 1 "fpmove_src_operand" "F,m,d"))]
  "TARGET_NUMERICS && i960_cannot_use_g14_for_zero_store()"
  "*
{
  switch (which_alternative)
    {
  ...
  [(set_attr "type" "load,fpload,fpstore")])
...
(define_insn "*movsf_fp_literal"
 [(set (match_operand:SF 0 "register_operand" "=df")
     (match_operand:SF 1 "fp_literal" "GH"))]
 "TARGET_NUMERICS"
 "movr\t%1,%0"
 [(set_attr "type" "fpmove")])

(define_insn "*movsf2_internal_same_to_same"
 [(set (match_operand:SF 0 "register_operand" "=f,d,f,d")
     (match_operand:SF 1 "register_operand" "f,d,d,f"))]
 "TARGET_NUMERICS"
 "@
 movr\t%1,%0
 mov\t%1,%0
...
(define_insn "*movsf2_internal_g14_available"
  [(set (match_operand:SF 0 "nonimmediate_operand" "=d,d,m")
	(match_operand:SF 1 "fpmove_src_operand" "F,m,dG"))]
  "TARGET_NUMERICS && i960_can_use_g14_for_zero_store()"
  "*
{
  switch (which_alternative)
...
(define_insn "*movsf2_internal_g14_unavailable"
  [(set (match_operand:SF 0 "nonimmediate_operand" "=d,d,m")
	(match_operand:SF 1 "fpmove_src_operand" "F,m,d"))]
  "TARGET_NUMERICS && i960_cannot_use_g14_for_zero_store()"
  "*
{
  switch (which_alternative)
...
(define_insn "*movtf_fp_literal"
 [(set (match_operand:TF 0 "register_operand" "=df")
     (match_operand:TF 1 "fp_literal" "GH"))]
 "TARGET_NUMERICS"
 "movre\t%1,%0"
 [(set_attr "type" "fpmove")])

(define_insn "*movtf2_internal_same_to_same"
 [(set (match_operand:TF 0 "register_operand" "=f,d,f,d")
     (match_operand:TF 1 "register_operand" "f,d,d,f"))]
 "TARGET_NUMERICS"
 "@
   movre\t%1,%0
   movt\t%1,%0
...
(define_insn "*movtf2_load_store"
  [(set (match_operand:TF 0 "nonimmediate_operand"  "=d,d,m")
	    (match_operand:TF 1 "fpmove_src_operand"    "F,m,d"))]
  "TARGET_NUMERICS && (register_operand (operands[0], TFmode) || register_operand (operands[1], TFmode))"
  "* {
  switch (which_alternative)
    {
    case 0:
