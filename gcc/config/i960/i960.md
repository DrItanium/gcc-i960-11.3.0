...
(define_insn ""
  [(set (match_operand:DF 0 "nonimmediate_operand" "=r,d,d,m,o")
	(match_operand:DF 1 "fpmove_src_operand" "r,F,m,d,G"))]
  "i960_can_use_g14_for_zero_store()
...
(define_insn ""
  [(set (match_operand:DF 0 "nonimmediate_operand" "=r,d,d,m")
	(match_operand:DF 1 "fpmove_src_operand" "r,F,m,d"))]
  "i960_cannot_use_g14_for_zero_store()
   && (register_operand (operands[0], DFmode)
       || register_operand (operands[1], DFmode))"
  "*
...
(define_insn "*movsf_fp_literal"
 ...
 [(set_attr "type" "fpmove")])
(define_insn ""
  [(set (match_operand:SF 0 "nonimmediate_operand" "=r,d,d,m")
	(match_operand:SF 1 "fpmove_src_operand" "r,F,m,dG"))]
  "i960_can_use_g14_for_zero_store()
...
(define_insn ""
  [(set (match_operand:SF 0 "nonimmediate_operand" "=r,d,d,m")
	(match_operand:SF 1 "fpmove_src_operand" "r,F,m,d"))]
  "i960_cannot_use_g14_for_zero_store()
   && (register_operand (operands[0], SFmode)
       || register_operand (operands[1], SFmode))"
  "*
