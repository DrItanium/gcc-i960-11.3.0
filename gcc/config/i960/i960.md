...
(define_insn ""
  ...
  ""
  "cmpi	%0,%1 # set ?cc to compare integer %0 to %1"
  [(set_attr "type" "compare")])

(define_insn ""
  [(set (reg:CC_UNS CC_REG)
	(compare:CC_UNS (match_operand:SI 0 "register_operand" "d")
			(match_operand:SI 1 "arith_operand" "dI")))]
  ""
  "cmpo	%0,%1 # set ?cc to compare ordinal %0 to %1"
  [(set_attr "type" "compare")])
...
(define_insn ""
  ...
  ""
  ;; "b%C0%+ %l1"
  "b%C0\t%l1 # if ?cond then label else pc"
  [(set_attr "type" "branch")])
...
(define_insn ""
  ...
  ""
  ;; "b%I0%+ %l1"
  "b%I0\t%l1 # if ?cond then pc else label"
  [(set_attr "type" "branch")])
...
(define_insn ""
  ...
  ""
  ;; "b%C0%+ %l1"
  "b%C0\t%l1 # if ?cc_uns then label else pc"
  [(set_attr "type" "branch")])
...
(define_insn ""
  ...
  ""
  ;; "b%I0%+ %l1"
  "b%I0\t%l1 # if ?cc_uns then pc else label"
  [(set_attr "type" "branch")])
