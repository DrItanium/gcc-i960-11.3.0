...
;;  [(set (match_operand:SI 0 "" "")	;;- register dest
;;	(match_operand:SI 1 "" ""))	;;- memory src
;;   (use (match_operand:SI 2 "" ""))]	;;- nregs
;;  ""
;;  "
;;{
...
;;  while (count >= 4 && isQuadRegisterAligned(regno)) {
;;    emit_move_insn (gen_rtx_REG(TImode, regno),
;;                    adjust_address (operands[1], TImode, offset));
;;    count -= 4;
;;    regno += 4;
;;    offset += 16;
;;  }
...
;;              adjust_address (operands[1], DImode, offset));
;;      count -= 2;
;;      regno += 2;
;;      offset += 8;
;;  }
  ...
  "*
{
  switch (which_alternative)
    ...
    case 2:
      return i960_output_ldconst (operands[0], operands[1]);
    case 3:
      return \"ldl	%1,%0 # load long 0\";
    case 4:
      return \"stl	%1,%0 # store long 0\";
    case 5:
  ...
  "*
{
  switch (which_alternative)
    ...
    case 2:
      return i960_output_ldconst (operands[0], operands[1]);
    case 3:
      return \"ldl	%1,%0 # load long 1\";
    case 4:
      return \"stl	%1,%0 # store long 1\";
    default:
      abort();
    }
}"
